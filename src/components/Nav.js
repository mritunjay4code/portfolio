...
const Nav = () => {
  ...
  return (
    <nav className="bg-white text-gray-600 fixed w-full z-20 shadow-lg  ">
      <div className="container mx-auto flex justify-between items-center px-6 py-4">
        ...
        {/* Desktop Menu */}
        <div className="hidden md:flex xl:flex space-x-8">
          <Link className="hover:text-cyan-500" to="/">
            Home
          </Link>

          <Link className="hover:text-cyan-500" to="/skils">
            Skils
          </Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white">
          <Link className="block px-6 py-2 hover:bg-cyan-500" to="/">
            Home
          </Link>

          <Link className="block px-6 py-2 hover:bg-cyan-500" to="/skils">
            Skils
          </Link>

          <Link className="block px-6 py-2 hover:bg-cyan-500" to="/project">
            Projects
          </Link>

          <Link className="block px-6 py-2 hover:bg-cyan-500" to="/Contact">
            Contact
          </Link>
        </div>
      )}
...
//             Home
//           </a>
//           <a href="#skils" className="hover:text-cyan-500">
//             Skils
//           </a>
...
//             Home
//           </a>
//           <a href="#skils" className="block px-6 py-2 hover:bg-cyan-500">
//             Skils
//           </a>
